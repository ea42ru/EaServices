...
SET PR_SERVICE_NAME=SimplyService
SET PR_JAR=SimplyService.jar
SET START_CLASS=ru.ea42.EaServices.TestSymplyStart
SET START_METHOD=start
SET STOP_CLASS=ru.ea42.EaServices.TestSymplyStart
